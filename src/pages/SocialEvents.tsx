...
const socialData: EventPageData = {
  ...
  heroImage: socialImg,
  heroAlt: "Elegant social celebration in luxury banquet hall at Palacio Event Centre",
  intro: {
    eyebrow: "Social Events",
    heading: "Make Every Milestone Unforgettable",
    paragraphs: [
      "Life's most meaningful moments deserve an exceptional setting. Whether you're celebrating a milestone birthday, a golden anniversary, a graduation, or a special family gathering, Palacio Event Centre provides the luxurious backdrop that transforms any occasion into a treasured memory.",
  ...
  experience: {
    ...
    paragraphs: [
      "At Palacio, we understand that social events are deeply personal. Every birthday toast, every anniversary dance, and every family reunion carries its own story — and we're here to make sure that story unfolds beautifully.",
      "From custom décor to curated menus, our team collaborates with you to design an event that feels authentically yours. The result is a celebration that your guests experience as effortless, elegant, and genuinely joyful.",
    ],
    highlights: [
      "Flexible layouts for 50 to 900 guests",
      "Custom theme and décor coordination",
